...
```
/home/bricker/.local/share/billion-context/ca/combined-ca.pem
```
...
- `/home/bricker/.local/share/billion-context/ca/combined-ca.pem` — Billion-context CA certificate
