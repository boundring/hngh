...
SECRET_ITEMS = {
    ...
    'GITHUB_PAT_TOKEN': 'GitHub PAT (GITHUB_PAT_TOKEN)',
    ...
    'GROQ_API_KEY': 'Groq',
    'XAI_API_KEY': 'xAI',
    'KIMI_FOR_CODING_KEY': 'Kimi (KIMI_FOR_CODING_KEY)',
    'KIMI_AI_KEY': 'Kimi AI (KIMI_AI_KEY)',
    'MOONSHOTAI_API_KEY': 'Moonshot AI',
    'MINIMAX_API_KEY': 'MiniMax',
    'Z_AI_API_KEY': 'Z.AI (Z_AI_API_KEY)',
    'ZAI_API_KEY': 'Z.AI / Zhipu route',
    'ZHIPU_API_KEY': 'ZHIPU',
    'ELEVENLABS_API_KEY': 'ElevenLabs (ELEVENLABS_API_KEY)',
    'PYPI_API_KEY': 'PyPI (PYPI_API_KEY)',
    'AGENT_MAIL_API_KEY': 'Agent Mail',
    'OPENCODE_API_KEY': 'OpenCode (OPENCODE_API_KEY)',
