...
PATHY='Checked /home/bricker/secret.txt and /tmp/cache then ~/.hngh/db/telemetry.db plus a bare /home and /tmp, a url https://example.com/doc and www.example.com/home/x; kept prose.
...
out="$(call "archive me /home/bricker/x")"
...
[ -n "$arch" ] && grep -qF "/home/bricker/x" "$arch" &&
