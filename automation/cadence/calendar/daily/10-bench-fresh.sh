...
# benchmarks are event-driven now (cadence/calendar/weekly/02-bench-trigger.sh, plan
...
# usage: cadence/calendar/daily/10-bench-fresh.sh   (via cadence-tick.sh TIER=calendar)
set -u
