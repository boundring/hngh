...
#
# usage: cadence/calendar/daily/17-torch-audit.sh   (via cadence-tick.sh TIER=calendar)
set -u
...
SPLICED="$(mktemp)"
{
 ...
 printf 'hngh-automation `cadence/calendar/daily/17-torch-audit.sh` — do not hand-edit\n'
