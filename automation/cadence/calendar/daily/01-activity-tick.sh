...
# performs-or-files its next increment. The calendar tier advances the daily
...
#
# usage: cadence/calendar/daily/01-activity-tick.sh   (via cadence-tick.sh TIER=calendar)
set -u
