...
The long-form record is assembled into one file,
[docs/publication/book.md](docs/publication/book.md) (with an
[EPUB](docs/publication/hngh-memoir.epub) alongside it) — the intent,
the architecture, the decisions, and the research chapters in one
readable spine, generated by `scripts/generate-publication --ebook`.
