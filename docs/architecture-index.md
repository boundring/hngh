...
|---|---|---|---|---|
| **A — node lattice** (pinned admission before pooling; in place) | system-harness rung A; promo rungs 11–18 | `node-lattice-admission`, `wake-mutation-lane` (rotation beat executed 2026-09-09; src mutation unblocked by the operator-flexibility doctrine), `bridge-operator-host`, `key-rotation-freshness` | Node-lattice admission rung; Certificate-bound wake lane; Bridge-as-operator-host | `2026-08-24-design-distributed-attestation`, `r12`, `r14`, `r15`, `r17-wake-peer`, `r18-worker-transport` |
| **omp↔hngh integration** (operator UI/UX direction) | `docs/project/plans/2026-09-09-omp-hngh-integration.plan.md`; `docs/records/2026-09-09-operator-flexibility-doctrine.md` | propose-surface plans; queue priority key (2026-09-09 schedule-optimization) | omp↔hngh integration plan; Meta-optimization priority | `2026-09-09-omp-bridge` (08-26), `2026-09-09-1password-service-account-interface`, `2026-09-09-operator-flexibility-doctrine` |
