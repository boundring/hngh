...
## 2026-08-18-tagit-history-redacted-2026-09-20
...
<function=Bash>
<parameter=command>
ls -la ~/Projects/etc/hngh 2>/dev/null && echo "---HNHG EXISTS---" || echo "HNHG NOT FOUND at that path"; echo "==="; ls -la ~/Projects/etc 2>/dev/null | head -50
</parameter>
