...
- `[[sources/high-risk-file-collision-in-nightly-cycle-orchestrator]]` — prior work on file collisions in nightly orchestration cycles; confirms that namespace reuse under scheduling is an established failure mode.
