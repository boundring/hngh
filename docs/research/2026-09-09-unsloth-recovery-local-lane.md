...
- `unsloth-warm.service` (user, ~/.config/systemd/user/): disabled, inactive (oneshot, Type=oneshot, TimeoutStartSec=900, ExecStart=`~/.local/bin/unsloth-warm.sh` warms gemma-4-12b on :8888)
- `unsloth-studio.service` (user, ~/.config/systemd/user/): enabled, active (Restart=on-failure, RestartSec=10, ExecStart=`~/.local/bin/unsloth studio`)
...
- `~/.cache/huggingface/hub/models--unsloth--Ornith-1.0-35B-GGUF/blobs/4451803948c353ef2c84567e7add0654a32938e033fd44a1a2c0c4f5441cef82` (~12 GB, UD-Q2_K_XL quantization, GGUF format)
- `~/.cache/huggingface/hub/models--unsloth--Ornith-1.0-35B-GGUF/snapshots/78e1321ef86b69126dc991f481bb0cdc37614ed0/mmproj-F16.gguf` (0.9 GB, multimodal projector)
- Symlink: `~/.cache/huggingface/hub/models--unsloth--Ornith-1.0-35B-GGUF/snapshots/78e1321ef86b69126dc991f481bb0cdc37614ed0/Ornith-1.0-35B-UD-Q2_K_XL.gguf`
