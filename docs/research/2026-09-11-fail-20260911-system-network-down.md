...
- **T4:** Reconcile with the orchestrator collision risk ([[sources/high-rigit-history-redacted-2026-09-20]]): if the probe self-interference mechanism (F2.3) is confirmed, probe scheduling and orchestrator scheduling become one design problem, not two.
...
- [[sources/high-rigit-history-redacted-2026-09-20]] — llm-wiki vault pointer (read-only), basis for the nightly-orchestrator context in F2 and T4.
