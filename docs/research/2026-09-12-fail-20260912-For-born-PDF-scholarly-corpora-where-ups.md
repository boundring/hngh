...
1. **Use GROBID for Initial Extraction:**
   - **Repository Path:** `~/Projects/etc/hngh/grobid-extraction`
...
2. **Post-Processing with TEI XML:**
   - **Repository Path:** `~/Projects/etc/hngh/tei-postprocessing`
...
3. **Evaluate Against R1 Criteria:**
   - **Repository Path:** `~/Projects/etc/hngh/r1-criteria`
...
4. **Automate the Pipeline:**
   - **Repository Path:** `~/Projects/etc/hngh/automation-pipeline`
...
1. **GROBID Repository:**
   - Path: `~/Projects/etc/hngh/grobid-extraction`

2. **TEI Postprocessing Repository:**
   - Path: `~/Projects/etc/hngh/tei-postprocessing`

3. **R1 Criteria Repository:**
   - Path: `~/Projects/etc/hngh/r1-criteria`

4. **Automation Pipeline Repository:**
   - Path: `~/Projects/etc/hngh/automation-pipeline`
