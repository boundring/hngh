...
4. **Task statement** naming the kernel repository at `/home/bricker/Projects/etc/hngh`. No file paths within that repository are cited in this record because none could be verified from the supplied material.
