...
- **[[sources/high-rigit-history-redacted-2026-09-20]]** — prior art (read-only vault pointer): "Three plans writing overnight." Source of risk signal F3a. Treated as a named pointer, not as live log data.
