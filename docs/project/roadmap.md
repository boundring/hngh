...
| 4 | C6 planner cycle (roadmap → task queue → squad dispatch) + **signals layer** (typed agent↔agent control channel — eases all later coordination) | **In progress** (W0 parser done: `hngh-planner.lisp`, 515/515 @ e173d21; W1 decomposition/weighting/emission + W1.5 signals next) |
