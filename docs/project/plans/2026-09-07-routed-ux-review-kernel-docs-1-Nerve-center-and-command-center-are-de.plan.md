...
at 2026-09-07T06:00:36Z. Alert text: 1. "Nerve center" and "command center" are dead metaphors for UI surfaces; cut them to name the webapp and CLI directly -> `design/command-center.md` fix or park with cause
