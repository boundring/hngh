<!-- plan: status=executed risk=normal accepted=2026-09-23T00:04:17Z -->
...
- [x] Step 1 — pin every Unsloth load to a standardized context
...
- [x] Step 4 — correct the crash brief trigger chain + the OOM
  prevention handoff queue (bounded-context landing, Ternary Bonsai
  activation path) — 2026-09-22 evening.
