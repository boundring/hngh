...
- [ ] Verify tailnet reachability once per day: from the desktop,
...
- [ ] Document the operator-side HTTPS upgrade in REMOTE-ACCESS.md:
...
- [ ] Add the daily budget digest: one progress row per day summarizing
