<!-- plan: status=executed risk=normal accepted=2026-09-12T20:32:27Z routed-from=correction-407311fb -->
# 2026-09-12 — routed candidate

Routed by scripts/router-tick.py from alert identity `correction-407311fb`
at 2026-09-12T19:00:14Z. Alert text: correction 407311fb: no named check found (We're copying and pasting the parts of this page that are not being displayed correctly: ``` BEGIN OF PASTE wake-mutatio)
