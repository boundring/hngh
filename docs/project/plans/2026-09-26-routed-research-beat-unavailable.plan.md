<!-- plan: status=proposed risk=normal accepted=- routed-from=research-beat:unavailable -->
<!-- attempt: 1 -->
<!-- expires: 2026-10-03T01:00:13Z -->
principle: routed candidates keep alert lineage machine-visible (docs/project/plans/README.md)
# 2026-09-26 — routed candidate

Routed by scripts/router-tick.py from alert identity `research-beat:unavailable`
at 2026-09-26T01:00:13Z. Alert text: research review unavailable: model chain down (none:archive-only)
