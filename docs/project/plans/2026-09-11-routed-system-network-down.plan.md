<!-- plan: status=proposed risk=normal accepted=- routed-from=system-network-down -->
...
- [ ] Delve: open research subject fail-20260911-system-network-down for system-network-down; record disposition; then fix or park
