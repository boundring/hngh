<!-- plan: status=expired risk=normal accepted=- routed-from=overnight:plan-accept-gate:kernel  cause=obsolete disposed=2026-09-13T09:00:49Z reason=identity re-occurred 3 times without landing; operator escalation stands -->
