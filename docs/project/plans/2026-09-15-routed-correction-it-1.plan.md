<!-- plan: status=proposed risk=normal accepted=- routed-from=correction-it-1 -->
...
- [ ] Delve: open research subject fail-20260915-correction-it-1 for correction-it-1; record disposition; then fix or park
