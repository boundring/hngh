...
- [x] Read docs/research/2026-08-28-log-presentation-patterns.md and
      ...
      component notes.
- [x] Write docs/design/research-page-spec.md: the research tab renders
...
- [x] File a progress row for each spec via report-queue and leave the
      two spec files in the working tree for the next ceremony
      (rows e654253f, ef36ca89; specs untracked in hngh docs/design/).
