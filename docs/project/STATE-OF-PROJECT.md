...
- Research lines: 123 reviewed, 24 planned, 4 crystallized (hngh-automation/research-lines.tsv).
- Queue Next: node-lattice-admission, set 2026-09-13 (2 days old) (hngh docs/project/queue.md).
- Plan ledger: 274 plan files, 221 routed candidates (hngh docs/project/plans/).
- Operator items: 5 open (hngh-automation/dashboard/operator-items.json; display cap 40).
