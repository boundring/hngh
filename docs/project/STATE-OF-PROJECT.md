...
- Research lines: 231 reviewed (hngh-automation/research-lines.tsv).
- Queue Next: key-rotation-freshness, set 2026-09-16 (4 days old) (hngh docs/project/queue.md).
- Plan ledger: 475 plan files, 381 routed candidates (hngh docs/project/plans/).
