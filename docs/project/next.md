...
| P0 | **Wave C security baseline** — immutable safety layer, sandboxing for agent-generated code, append-only action log, `:operation` human gate for core-file commits + dep installs (unsigned gate: no self-modification of core until this lands) | hngh; `docs/design/autonomy-strategy.md` §7 |
