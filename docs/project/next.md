...
| Priority | Item | Where |
|---|---|---|
| P0 | **L2/L3 build steps 4–6** — judge model (cheap/local, offline-calibrated first), case-base + review loop, cross-agent normalization (steps 1–3 done `0c62fa9`) | `docs/design/situation-scoring.md` §8; hngh |
