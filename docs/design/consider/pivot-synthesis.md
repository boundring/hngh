...
analyst artifacts (now promoted to docs/design/consider/), live verification, and
...
- All evidence lives in docs/design/consider/ (promoted 2026-09-15
  from .agent-scratch/consider/; 4 analyst artifacts)
  plus this synthesis.
