...
Errata (2026-09-15, factual audit against the working tree; folds the
d4-principles correction sidecar): two live-fact corrections bind this
spec to the audited tree. (1) The patrol gate-crumb freshness TTL
exists: automation/jobs/patrol.py sets GATE_CRUMB_TTL_S=86400 (env
override PATROL_GATE_CRUMB_TTL_S, landed in commit d0bcb477 on
2026-09-15; line 60 in the tree at promotion time, line 58 when the
audit sidecar was written), and stale crumbs now degrade to one
dedupable gate-stale
fail rather than deciding, so R4's "newest-crumbs-wins, no TTL"
before-state describes only the pre-d0bcb477 tree. (2) The cadence
tier count is 8 live tiers (1m/5m/10m/30m/hour/day/week/month, per
automation/cadence/README.md), not 9, so R1/H3 corrections apply.
Section 2.3 and R6 counts are re-pinned inline with exact measurement
commands.

Inputs: d4-principles artifact (26 principles, 5 families, keep/shrink/drop),
consider/refactor-assessment.md (sizing, debt inventory, strangler option),
consider/research-lifecycle-audit.md (pipeline audit, HARVEST proposal),
consider/memory-systems-survey.md (exclusive-writer analysis),
consider/pivot-synthesis.md (D1-D7 list, pivot-vs-evolve verdict), git
show bdee3708 (expiry+escalation landed).
...
- Carried, not rebuilt: the existing ledger spine (src/ 8.5k LOC Lisp,
  ...
  self-contained, and is the hardest asset to re-earn. [consider/refactor-assessment.md:5,21]
...
[consider/research-lifecycle-audit.md:4-10; consider/pivot-synthesis.md:11-20]
...
writers, not shared storage. [consider/memory-systems-survey.md:44-48; consider/pivot-synthesis.md:99-110]
...
[consider/refactor-assessment.md:29-37] Sequence after D1/D2 prove the rhythm
(synthesis D5).
...
- Evidence: 8 live tiers (1m/5m/10m/30m/hour/day/week/month,
  cadence/README.md; consider/refactor-assessment.md:6 misstated this as 9) for
  ...
  [consider/refactor-assessment.md:6,24]
...
- Evidence: cause=unknown cancellations is a named real defect in the
  ...
  resolve at the source. [consider/refactor-assessment.md:11,26]
...
- Evidence: backlog is 1,769 lines / 84 sections with 7 items still
  ...
  [consider/refactor-assessment.md:6,10]
...
- Evidence (restated honestly, 2026-09-15): the false red-gate class
  ...
  gates post-hoc). [consider/refactor-assessment.md:11,13,25]
...
- Evidence: stages 2, 3, 5 all nominally open; stage 2 "landing" since
  ...
  evidence of running. [consider/refactor-assessment.md:12]
...
- Evidence: planned rows churning without crystallizing; most lines sit
  ...
  [consider/refactor-assessment.md:11; consider/research-lifecycle-audit.md:4-10]
...
dashboard; current total ~80.5k LOC. [consider/refactor-assessment.md:3-6]
...
dispatch/newspaper/manga userspace outputs. [consider/refactor-assessment.md:31-33;
consider/pivot-synthesis.md:62-71]
