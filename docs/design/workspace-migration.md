...
- src/plugins/dashboard-tui.lisp: *watch-root*, *seat-registry-
  ...
  *claims-register-path* (all ~/.hngh-night/...)
- ~/.local/bin/hngh-watch: HNGH_HOME env with default
  ~/.hngh-night (SCHEDULES/CONTROL/OUTCOME_LOG under
  HNGH_WATCH_CONFIG)
...
4. Acceptance for the seam: `grep -rn '~/.hngh-night'
