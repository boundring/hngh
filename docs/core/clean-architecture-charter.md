...
contains `create-run`, `arm-run`, and `start-run` with capability-specific inward
ports and closed results. `hngh:validate-profile` remains a compatibility facade.
