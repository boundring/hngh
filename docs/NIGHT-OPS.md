...
- Harness home: `~/Projects/etc/hngh-automation` (this repo).
...
- Hngh core: `~/Projects/etc/hngh` — promotion rung 12 landed
...
2. `git -C . log --oneline -5` and `git -C ~/Projects/etc/hngh log --oneline -5`.
...
- `git -C ~/Projects/etc/hngh log --oneline --since="18 hours ago"`
