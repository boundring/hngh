...
(defvar *watch-root* "~/.hngh-night/watch/"
...
(defvar *seat-registry-path* "~/.hngh-night/seat-names.md"
  "Path to the seat registry.")

(defvar *owner-inbox-path* "~/.hngh-night/owner/inbox.md"
  "Path to the owner-facing decision inbox.")

(defvar *seat-lanes-root* "~/.hngh-night"
  "Root containing tandem seat lane directories.")

(defvar *claims-register-path* "~/.hngh-night/state/claims.lisp"
