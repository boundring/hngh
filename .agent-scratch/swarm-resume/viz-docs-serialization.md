...
Repo: ~/src/jcode (read-only). Evidence gathered from docs/README.md, docs/MODULAR_ARCHITECTURE_RFC.md, crates/jcode-message-types, crates/jcode-protocol, crates/jcode-side-panel-types, sdk/typescript/src.
