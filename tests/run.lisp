...
(load (project-file "src/domain/course.lisp"))
...
(load (project-file "src/application/admit-transport.lisp"))
(load (project-file "src/application/select-course.lisp"))
...
(load (project-file "src/adapter/model.lisp"))
...
(load (cl-user::project-file "tests/domain/test-course.lisp"))
...
(load (cl-user::project-file "tests/application/test-select-course.lisp"))
