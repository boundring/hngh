...
- **Tests**: `make test` green — 390/390 @ uncommitted (W5 prompt matrix built: generate-prompt, 36-skeleton library, bone fillers, flesh pass, D-040 synced model selection, prompt cache; generate-pm-prompt now delegates)
