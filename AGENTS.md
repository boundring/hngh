...
- **Tests**: `make test` green — 589/589 fast @ 24cb470 (W5 prompt matrix committed: generate-prompt, 36-skeleton library, bone fillers, flesh pass, D-040 synced model selection, prompt cache; generate-pm-prompt now delegates)
