...
- **Tests**: `make test` green — 390/390 fast @ 9e86a90 (W5 prompt matrix committed: generate-prompt, 36-skeleton library, bone fillers, flesh pass, D-040 synced model selection, prompt cache; generate-pm-prompt now delegates)
