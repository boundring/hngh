...
- **Tests**: `make test` green — 914/914 fast @ 6e6ddcb (L2/L3 Tier-0 situation detectors + L3 scorer + semantic judge + persistent case-base/review loop built; W5 prompt matrix committed: generate-prompt, 36-skeleton library, bone fillers, flesh pass, D-040 synced model selection, prompt cache)
