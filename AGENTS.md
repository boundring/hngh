...
- **Tests**: `make test` green — 494/494 fast @ b7ab4ab (W5 prompt matrix committed: generate-prompt, 36-skeleton library, bone fillers, flesh pass, D-040 synced model selection, prompt cache; generate-pm-prompt now delegates)
